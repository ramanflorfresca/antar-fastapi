...
"""
    ...
    if _using_master:
        ...
        _voice_rules = (
            ...
            "7. NEVER parenthetically define planets: NOT 'Venus (love, money)' — "
            "just use the energy name directly.\n"
            ...
            "  GOOD: 'Your growth and wisdom energy in your creativity area is running dim right now'\n"
            "  BAD:  'Mars chapter ends August 2026, then Rahu chapter begins'\n"
            "  GOOD: 'Your action-and-drive chapter closes August 2026, then your desire-and-amplification chapter opens'\n"
            "  BAD:  'Ketu transiting through your 11th house'\n"
            "  GOOD: 'Your release energy is currently moving through your gains area'\n"
            "  BAD:  'Venus planet of (love, partnership, money) in house 11'\n"
            "  GOOD: 'Your beauty and harmony energy in your gains area'\n"
        )
        _format_rules = (
