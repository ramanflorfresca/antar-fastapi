...
ARCHETYPE_LIBRARY = {
    ...
    ("ADAPTATION", "PENETRATE"): {
        ...
        "edge": "Thrives in volatile, high-change environments where rigid players fail.",
        "blind_spot": "Can lose a consistent identity when adapting too often.",
        "rarity": "TOP 8% OF PROFILES",
        "field": "ADAPTATION",
        "mode": "PENETRATE",
    },
    ("STRATEGY", "EXPAND"): {
        ...
        "edge": "Turns complex problems into scalable, repeatable systems.",
        "blind_spot": "Can over-engineer solutions that need simplicity.",
        "rarity": "TOP 7% OF PROFILES",
        "field": "STRATEGY",
        "mode": "EXPAND",
    },
    ("SIGNAL", "SEEK"): {
        ...
        "edge": "Early mover advantage — consistently identifies opportunities ahead of the market.",
        "blind_spot": "Can chase novelty and abandon things before they fully pay off.",
        "rarity": "TOP 9% OF PROFILES",
        "field": "SIGNAL",
        "mode": "SEEK",
    },
    ("AUTHORITY", "DISSOLVE"): {
        ...
        "edge": "Can finalize deals, decisions, and situations others have been circling for months.",
        "blind_spot": "Can be perceived as dismissive when others need more processing time.",
        "rarity": "TOP 6% OF PROFILES",
        "field": "AUTHORITY",
        "mode": "DISSOLVE",
    },
    ("COMPLETION", "DISSOLVE"): {
        ...
        "edge": "Brings projects, relationships, and cycles to clean resolution.",
    ...
    ("STORM", "BALANCE"): {
        ...
        "edge": "Maintains equilibrium and output in high-pressure, chaotic environments.",
    ...
    ("THRESHOLD", "REFINE"): {
        ...
        "edge": "Raises the quality ceiling of everything you touch.",
    ...
    ("DISCOVERY", "STRUCTURE"): {
        ...
        "edge": "Translates frontier insight into structured, actionable knowledge.",
    ...
    ("ANCHOR", "EXPAND"): {
        ...
        "edge": "Creates growth that is both ambitious and durable.",
        "blind_spot": "Can slow expansion by over-protecting what has already been built.",
        "rarity": "TOP 10% OF PROFILES",
        "field": "ANCHOR",
        "mode": "EXPAND",
    },
    ("THRESHOLD", "DISSOLVE"): {
        ...
        "edge": "Exceptional at transitions, decisions, and knowing when cycles are complete.",
    ...
    ("EDGE", "EXPAND"): {
        ...
        "edge": "First-mover instinct combined with the drive to scale what is found.",
        "blind_spot": "Can outpace the support structures needed to sustain what was built.",
        "rarity": "TOP 5% OF PROFILES",
        "field": "EDGE",
        "mode": "EXPAND",
    },
    ("DISCOVERY", "DRIVE"): {
        ...
        "edge": "Combines intellectual curiosity with the drive to test ideas in the real world.",
    ...
    ("DISCOVERY", "EXPAND"): {
        ...
        "edge": "Takes nascent insights and builds them into scalable advantage.",
    ...
    ("ABUNDANCE", "PENETRATE"): {
        ...
        "edge": "Identifies and activates latent value that others overlook.",
    ...
    ("ROOT", "CONNECT"): {
        ...
        "edge": "Creates deep, lasting loyalty that compounds over time.",
    ...
    ("STORM", "STRUCTURE"): {
        ...
        "edge": "Converts intense drive into consistent, structured output.",
    ...
    ("ADAPTATION", "BALANCE"): {
        ...
        "edge": "Keeps complex, changing situations from falling apart.",
    ...
    ("STRATEGY", "PROTECT"): {
        ...
        "edge": "Prevents failures that others never see coming.",
    ...
    ("THRESHOLD", "DRIVE"): {
        ...
        "edge": "Activates untapped potential in people and situations.",
    ...
    ("VICTORY", "PENETRATE"): {
        ...
        "edge": "Consistent high performance with the insight to replicate it.",
    ...
    ("COMPLETION", "REFINE"): {
        ...
        "edge": "Delivers completed work at a consistently high standard.",
    ...
    ("STORM", "BUILD"): {
        ...
        "edge": "Exceptional output under pressure and in resource-constrained environments.",
    ...
    ("MOMENTUM", "SEEK"): {
        ...
        "edge": "Turns early signals into rapid, compounding progress.",
    ...
    ("ABUNDANCE", "EXPAND"): {
        ...
        "edge": "Consistently grows resources, networks, and opportunities beyond their starting point.",
