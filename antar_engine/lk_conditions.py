...
LK_CONDITIONS["kemadruma_active"] = {
    ...
    "gist": "Today is under pressure around your sense of being held — protect the day's softness, don't push for connection. The feeling-self in your chart sits alone in its birth pattern without immediate neighbors, and when a difficult transit crosses it, that pattern surfaces as a felt loneliness. The phone calls won't reach you. The reassurance won't land. Today's window is short — ride it through, don't try to fix it.",
    "cause": "Today's loneliness is a structural pattern in the chart, not a circumstantial one. The feeling-self, the part of you that feels held, has no immediate neighbors in your birth pattern. When the right transit hits, the pattern produces a felt experience of being unheld — even by people who are, in fact, holding you. The mismatch between what the world is offering and what you're able to receive is the painful part.",
    "do": "Tell one person, plainly: 'I'm having a hard day; I don't need you to fix it, but tell me you're there.' That sentence works because today's pain lives in the un-asked, un-named loneliness; naming it dissolves a layer of it. Eat warm food. Take a hot bath or shower. Sleep early. Limit social media — this kind of day amplifies the comparison-loneliness.",
    "dont": "Don't believe today's read of your relationships — this pattern makes you misread the warmth in your life as coldness. Don't withdraw from people in response to feeling unheld; the impulse will be strong and the result is the loneliness becoming actual. Don't make decisions about relationships today.",
    "areas_affected": [
