...
PRACTICE_LIBRARY = {
    "Sun": {
        ...
        "why_this_works": {"en": "This energy is the steady core of confidence and vitality. When it runs low, the self dims and recognition won't land. The seed mantra rekindles that central fire, the morning movement floods the body with light, and the offering clears what keeps it shadowed.",
                          "es": "Esta energía es el núcleo estable de la confianza y la vitalidad. Cuando está baja, el yo se atenúa y el reconocimiento no llega. El mantra semilla reaviva ese fuego central, el movimiento matinal inunda el cuerpo de luz, y la ofrenda despeja lo que la mantiene en sombra."},
        "frequency_hz": 126,
    },
    "Moon": {
        ...
        "why_this_works": {"en": "This energy sets the emotional baseline and the felt sense of safety. When it runs low, the mind churns and rest won't come. The mantra steadies the inner tide, the restorative posture signals safety to the nervous system, and the silver and milk are how you feed it.",
                          "es": "Esta energía marca la base emocional y la sensación de seguridad. Cuando está baja, la mente se agita y el descanso no llega. El mantra calma la marea interior, la postura restaurativa le indica seguridad al sistema nervioso, y la plata y la leche son la forma de alimentarla."},
        "frequency_hz": 210,
    },
    "Mars": {
        ...
        "why_this_works": {"en": "This energy rules drive and clean boundaries. When it runs low, effort leaks and force turns to friction. The mantra tempers the fire, the strong stance retrains controlled power, and the Tuesday offering settles the charge that force leaves behind.",
                          "es": "Esta energía rige el impulso y los límites limpios. Cuando está baja, el esfuerzo se filtra y la fuerza se vuelve fricción. El mantra templa el fuego, la postura firme reentrena el poder controlado, y la ofrenda del martes asienta la carga que deja la fuerza."},
        "frequency_hz": 144,
    },
    "Mercury": {
        ...
        "why_this_works": {"en": "This energy rules the channels through which thought becomes word and word becomes action. When it runs low, those channels jam. The mantra clears the seed-vibration, the breath rebalances the hemispheres, and the daily action clears what has been blocking them.",
                          "es": "Esta energía rige los canales por los que el pensamiento se vuelve palabra y la palabra se vuelve acción. Cuando está baja, esos canales se atascan. El mantra limpia la vibración semilla, la respiración reequilibra los hemisferios, y la acción diaria despeja lo que los ha estado bloqueando."},
        "frequency_hz": 282,
    },
    "Jupiter": {
        ...
        "why_this_works": {"en": "This energy rules expansion and grace. When it runs low, the world feels stingy and growth dries up. The mantra reopens the channel of fortune, the balancing posture trains steady uprightness, and the Thursday giving reopens what closed — generosity restores the flow.",
                          "es": "Esta energía rige la expansión y la gracia. Cuando está baja, el mundo se siente tacaño y el crecimiento se seca. El mantra reabre el canal de la fortuna, la postura de equilibrio entrena una verticalidad estable, y la entrega del jueves reabre lo que se cerró — la generosidad restaura el flujo."},
        "frequency_hz": 183,
    },
    "Venus": {
        ...
        "why_this_works": {"en": "This energy rules sweetness, relating, and the flow of value. When it runs low, connection and pleasure go flat. The mantra restores the seed-tone of harmony, the heart-opening posture softens defended places, and the Friday giving settles what has gone unreturned.",
                          "es": "Esta energía rige la dulzura, el vínculo y el flujo del valor. Cuando está baja, la conexión y el placer se apagan. El mantra restaura el tono semilla de la armonía, la postura que abre el pecho ablanda lo defendido, y la entrega del viernes asienta lo que no se ha devuelto."},
        "frequency_hz": 221,
    },
    "Saturn": {
        ...
        "why_this_works": {"en": "This energy rules slow-build, structure, and patience. When it runs low, time itself feels antagonistic — deadlines slip, momentum dies. The mantra is its seed sound; the daily action works off what has accumulated; the body practice trains the nervous system to settle into its rhythm. None of this is fast. That's the point.",
                          "es": "Esta energía rige la construcción lenta, la estructura y la paciencia. Cuando está baja, el tiempo mismo se siente antagonista — los plazos resbalan, el impulso muere. El mantra es su sonido semilla; la acción diaria salda lo acumulado; la práctica corporal entrena al sistema nervioso a asentarse en su ritmo. Nada de esto es rápido. Ese es el punto."},
        "frequency_hz": 295,
    },
    "Rahu": {
        ...
        "why_this_works": {"en": "This energy rules hunger and the pull toward the new. When agitated, it scatters the mind into anxious chasing. The mantra contains the static, the inversion drains the over-revved nervous system, and feeding crows settles its restless charge.",
                          "es": "Esta energía rige el hambre y el tirón hacia lo nuevo. Cuando se agita, dispersa la mente en una persecución ansiosa. El mantra contiene la estática, la inversión drena el sistema nervioso sobreacelerado, y alimentar cuervos asienta su carga inquieta."},
        "frequency_hz": 268,
    },
    "Ketu": {
